    ...
    <div className="min-h-screen bg-background text-base-content">
      <div className="container mx-auto px-4 py-8">
        ...
        <main className="flex-grow flex flex-col">
          ...
          <div className="bg-surface rounded-2xl p-6 mt-8 shadow-xl border border-surface-light">
            <div className="flex items-start">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
                className="stroke-info shrink-0 w-6 h-6 mr-3 mt-0.5"
              >
                <path
                  strokeLinecap="round"
        ...
        <footer className="text-center py-8 text-base-content/60 text-sm mt-12 border-t border-surface-light">
          <div className="mb-2">
