...
const FrameExtractor = ({ gifFile }) => {
  ...
  if (frames.length === 0) {
    return (
      <div className="flex justify-center items-center h-64 bg-surface rounded-2xl mt-8">
        <div className="text-center">
          <div className="inline-block animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-primary mb-4"></div>
          <p className="text-base-content/80">Extracting frames from your GIF...</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="mt-8 p-6 bg-surface rounded-2xl shadow-xl border border-surface-light">
      <h2 className="text-2xl font-bold mb-6 text-center text-base-content">Frame Gallery</h2>

      {/* Frame selection controls */}
      <div className="flex flex-wrap items-center justify-between gap-4 mb-6 p-4 bg-surface-light rounded-lg">
        <div className="flex items-center space-x-4">
          <button
            onClick={selectAllFrames}
            className="px-3 py-1 bg-primary text-white rounded hover:bg-primary-focus text-sm"
          >
            Select All
          </button>
          <button
            onClick={clearSelection}
            className="px-3 py-1 bg-surface text-base-content border border-surface-light rounded hover:bg-surface-light text-sm"
          >
            Clear Selection
          </button>
        ...
        <div className="flex space-x-2">
          <button
            ...
            className={`px-4 py-2 rounded flex items-center space-x-2 ${
              selectedFrames.size > 0
                ...
                : "bg-surface text-base-content/50 cursor-not-allowed"
            }`}
          >
            <svg
          ...
          <button
            ...
            className="px-4 py-2 bg-primary text-white rounded hover:bg-primary-focus flex items-center space-x-2"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5"
      ...
      <div className="mb-8 relative">
        <div className="bg-surface-light rounded-xl overflow-hidden shadow-lg mb-4 w-full flex justify-center items-center p-4">
          <img
            src={frames[currentSlide]?.blob}
            alt={`Frame ${currentSlide}`}
            className="max-h-[70vh] object-contain cursor-pointer rounded-lg"
        ...
        <button
          ...
          className={`absolute left-4 top-1/2 transform -translate-y-1/2 p-3 rounded-full bg-surface-light bg-opacity-80 text-base-content hover:bg-opacity-100 transition-all ${
        ...
        <button
          ...
          className={`absolute right-4 top-1/2 transform -translate-y-1/2 p-3 rounded-full bg-surface-light bg-opacity-80 text-base-content hover:bg-opacity-100 transition-all ${
        ...
        <div className="flex justify-between items-center mt-4">
          ...
          <div className="flex space-x-2">
            <button
              ...
              className="flex items-center space-x-1 px-3 py-2 bg-surface-light text-base-content rounded-lg hover:bg-surface-light/80 transition-colors"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-5 w-5"
            ...
            <button
              ...
              className={`flex items-center space-x-1 px-3 py-2 rounded-lg transition-colors ${
                selectedFrames.has(currentSlide)
                  ...
                  : "bg-surface-light text-base-content hover:bg-surface-light/80"
              }`}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
      ...
      {/* Thumbnails */}
      <div className="mt-8">
        <h3 className="text-xl font-semibold mb-4 text-base-content">All Frames</h3>
        <div className="flex space-x-4 overflow-x-auto pb-4 scrollbar-thin scrollbar-thumb-surface-light scrollbar-track-surface rounded-lg">
          {frames.map((frame, index) => (
            <div
              ...
              className={`flex-shrink-0 cursor-pointer rounded-lg overflow-hidden border-2 transition-all duration-200 relative ${
                currentSlide === index
                  ...
                  : "border-surface-light hover:border-base-content/30"
            ...
            >
              ...
              >
                <div
                  className={`w-5 h-5 rounded-full flex items-center justify-center ${
                    selectedFrames.has(index) ? "bg-secondary text-white" : "bg-surface-light/80 text-base-content"
                  }`}
                >
              ...
              <img src={frame.blob} alt={`Frame ${frame.index}`} className="w-24 h-24 object-cover" />
        ...
        <Dialog as="div" className="relative z-10" onClose={() => setShowFrameInfo(false)}>
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-surface p-6 text-left align-middle shadow-xl transition-all border border-surface-light">
                  <div className="flex justify-between items-center mb-4">
                    ...
                    <button
                      type="button"
                      className="inline-flex justify-center rounded-md border border-surface-light bg-surface-light px-4 py-2 text-sm font-medium text-base-content hover:bg-surface-light/80 focus:outline-none"
                  ...
                  {frameInfo && (
                    <div className="mt-2 space-y-3">
                      <div className="flex items-center justify-center bg-surface-light rounded-lg p-4">
                        <img
                          src={frameInfo.blob}
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div className="bg-surface-light p-3 rounded-lg">
                          ...
                          <p className="font-medium">{frameInfo.index + 1}</p>
                        </div>
                        <div className="bg-surface-light p-3 rounded-lg">
                          <p className="text-xs text-base-content/60">Delay</p>
                          <p className="font-medium">{frameInfo.delayMs}ms</p>
                        </div>
                        <div className="bg-surface-light p-3 rounded-lg">
                          <p className="text-xs text-base-content/60">Width</p>
                          <p className="font-medium">{frameInfo.dimensions.width}px</p>
                        </div>
                        <div className="bg-surface-light p-3 rounded-lg">
                          <p className="text-xs text-base-content/60">Height</p>
                          <p className="font-medium">{frameInfo.dimensions.height}px</p>
                        </div>
                      </div>
                    </div>
                  )}
                  <div className="mt-4">
                    <button
                      type="button"
                      className="inline-flex justify-center rounded-md border border-transparent bg-primary px-4 py-2 text-sm font-medium text-white hover:bg-primary-focus focus:outline-none w-full"
                      onClick={() => setShowFrameInfo(false)}
                    >
                      Close
                    </button>
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              <Transition.Child
                ...
                leaveTo="opacity-0 scale-95"
              >
                <Dialog.Panel className="w-full max-w-6xl transform overflow-hidden rounded-2xl bg-surface p-6 text-left align-middle shadow-xl transition-all border border-surface-light">
                  <div className="flex justify-between items-center mb-4">
                    <Dialog.Title as="h3" className="text-lg font-medium leading-6 text-base-content">
                  ...
                  <div className="mt-4 flex justify-between items-center">
                    ...
                    <button
                      type="button"
                      className="inline-flex justify-center rounded-md border border-transparent bg-primary px-4 py-2 text-sm font-medium text-white hover:bg-primary-focus focus:outline-none"
